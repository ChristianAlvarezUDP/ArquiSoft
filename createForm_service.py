...
def insert_question_into_db(question_text):
    ...
    try:
        ...
        conn = sqlite3.connect('arqui.db')
        cursor = conn.cursor()

        # Insert the question into the table
        cursor.execute("INSERT INTO campo_auditoria (titulo) VALUES (?)", (question_text,))
...
if __name__ == '__main__':
    ...
    threading.Thread(target=service_worker, args=("createForm_service", '127.0.0.1', 6002)).start()
